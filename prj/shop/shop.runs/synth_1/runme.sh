...
HD_PWD='D:/study/FPGA/study_project/shop/prj/shop/shop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shop_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shop_top.tcl
