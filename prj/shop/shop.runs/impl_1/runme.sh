...
HD_PWD='D:/study/FPGA/study_project/shop/prj/shop/shop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shop_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shop_top.tcl -notrace
